...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'owner සදහා පමනක් වන විධානයකි*_',
        owner: 'owner සදහා පමනක් වන විධානයක_!',
        mods: 'Perintah ini hanya dapat digunakan oleh _*Moderator*_ !',
        premium: 'ප්‍රිමියම් යූසර්ලා සදහා පමනකි !',
        group: 'සමූහ වල පමනක් වන විධානයකි!',
        private: 'ඉන්බොක්ස් චැට් වල පමනක් යොදාගන්නi!',
        admin: 'ඇඩ්මින් සදහා පමනයි!',
        botAdmin: 'මම ඇඩ්මින් වරයකු නොවේ',
        unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar Manusia.16*',
        restrict: 'තාවකාලිකව නවතා දමන ලද විධානයකි*!'
    }[type]
    if (msg) return conn.sendBut(m.chat, msg, wm, 'හරී 😴', 'හරී 😴', m)
}
